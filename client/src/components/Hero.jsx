    ...
    <>
      <div className=" mt-[20px] flex justify-center lg:flex lg:justify-center ">
        <div className=" z-0 lg:z-0  mt-[90px] mr-[-40px]   lg:mr-[-60px] lg:mt-[200px]">
          <button
            className="border-4 lg:border-8 border-white text-white h-[50px] w-[40px] lg:h-[200px] lg:w-[60px] lg:text-[40px]"
            onClick={previmg}
          >
            &#10094;
          </button>
        ...
        <img
          src={images[image]}
          className=" h-[200px] w-screen lg:h-[600px] lg:w-screen "
        ></img>
