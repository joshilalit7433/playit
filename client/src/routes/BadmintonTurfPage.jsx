  ...
  useEffect(() => {
    const fetchTurfs = async () => {
      try {
        ...
        // Ensure the response has a valid structure and contains turfs
        if (response.data && Array.isArray(response.data.turfs)) {
  ...
  return (
    <div className="lg:flex lg:flex-row">
      ...
      <div className="lg:w-3/4">
        <h1 className="lg:text-[25px] lg:mt-4 lg:mb-4 capitalize">Badminton Turfs</h1>
